...
function doTaskEachFrame() {
    ...
    const scrollEndX = leftCover.getBoundingClientRect().x + leftCover.getBoundingClientRect().width;
...
function init() {
    ...
    document.querySelector("#ticker-container").addEventListener("mouseover", () => {
        displacement_px = DISPLACEMENT_PX_SLOW;
    });
    document.querySelector("#ticker-container").addEventListener("mouseleave", () => {
